...
SWIFT_CLASS("_TtC5Macaw8Drawable")
...
SWIFT_CLASS("_TtC5Macaw4Node")
@interface Node : Drawable
- (void)onTouchTimerWithTimer:(NSTimer * _Nonnull)timer;
@property (nonatomic, readonly) NSUInteger hash;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC5Macaw5Group")
@interface Group : Node
@end


SWIFT_CLASS("_TtC5Macaw5Image")
